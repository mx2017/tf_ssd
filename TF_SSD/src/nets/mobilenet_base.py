...
#from nn_skeleton import batch_norm_layer
import numpy as np
...
def mobilenet_v1_base(mc,inputs,
...
def mobilenet_ext(inputs,mc,
  ...
  with tf.variable_scope(scope, 'MobilenetV1', [inputs],
    ...
    net = slim.conv2d(net, num_output, kernel_size=(3, 3), stride=1,
                activation_fn=None,scope="conv_predict",
                weights_initializer=weights_init,
                normalizer_fn=None)
    end_points['conv_predict'] = net
